...
class $c41144187e031f80$export$a1c8e230980baa0 {
    constructor(){
        ...
        this.examples.set("Machine Learning", [
            "SAM",
            "Melonoma"
        ]);
        this.examples.set("LLM", [
            "ImageCaptioning"
        ]);
        this.examples.set("Filters", [
            "Sobel",
            "Trako"
        ]);
        this.examples.set("Data Visualisation", [
            "Plotly"
        ]);
        this.examples.set("user interaction", [
            "LLM chat"
        ]);
    }
    /**
